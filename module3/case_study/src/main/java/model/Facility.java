...
public class Facility {
    ...
    public Facility(int id, String name, int area, double cost, int maxPeople, int rentTypeId, int facilityTypeId, String standardRoom, String descriptinonOtherConvenience, double poolArea, int numberOfFloors, String facilityFree) {
        ...
        this.descriptinonOtherConvenience = descriptinonOtherConvenience;
    ...
    public String getDescriptinonOtherConvenience() {
        return descriptinonOtherConvenience;
    }

    public void setDescriptinonOtherConvenience(String descriptinonOtherConvenience) {
        this.descriptinonOtherConvenience = descriptinonOtherConvenience;
    }
