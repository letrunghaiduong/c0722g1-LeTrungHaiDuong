use case_study;
insert into _position values(1,'Quản Lý'),
							(2,'Nhân Viên');
...
insert into division values (1, 'Sale-Marketing'), 
						   ...
						   (3, 'Phục vụ'),
						   (4, 'Quản lý');
insert into employee values (1,'Nguyễn Văn An','1970-11-07',456231786,10000000,0901234121,'annguyen@gmail.com','295 Nguyễn Tất Thành, Đà Nẵng',1,3,1), 
...
insert into attach_facility values (1,'Karaoke',10000,'giờ','tiện nghi, hiện tại'), 
								  (2,'Thuê xe máy',10000,'hiếc','hỏng 1 xe'),
								  (3,'Thuê xe đạp',20000,'chiếc','tốt'),
								  (4,'Buffet buổi sáng',15000,'suất','đầy đủ đồ ăn, tráng miệng'),
								  (5,'Buffet buổi trưa',90000,'suất','đầy đủ đồ ăn, tráng miệng'),
								  (6,'Buffet buổi tối',16000,'suất','đầy đủ đồ ăn, tráng miệng');                           
insert into contract values (1,'2020-12-08','2020-12-08',0,3,1,3), 
...
insert into contract_detail values (1,2,4,5),
									(2,2,5,8),
									(3,2,6,15),
									(4,3,1,1),
									(5,3,2,11),
