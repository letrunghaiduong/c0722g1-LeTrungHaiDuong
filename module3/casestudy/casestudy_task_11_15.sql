...
where (month(hd.ngay_lam_hop_dong) >= 10 and year(hd.ngay_lam_hop_dong) = '2020') 
and hd.ma_hop_dong not in(select hd.ma_hop_dong from hop_dong where (month(hd.ngay_lam_hop_dong) > 6 and year(hd.ngay_lam_hop_dong) = '2021'))
